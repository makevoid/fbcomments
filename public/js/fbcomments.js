(function() {
  ...
  FbComments = (function() {
    ...
    FbComments.prototype.comment_html = function(c) {
      ...
      general_blog = "";
      return "    <div class='fbc_comment'>      <div class='fbc_pic'><fb:profile-pic uid='" + c.user_id + "' linked='true'></fb:profile-pic></div>      <div class='fbc_from'>          <fb:name uid='" + c.user_id + "' linked='true'></fb:name> commented on <a href='" + c.post.url + "'>" + c.post.name + "</a> " + general_blog + " <span class='fbc_date'>" + (helpers.format_date(c.created_at)) + "</span>      </div>      <div class='fbc_message'>" + c.text + "</div>      </div>    </div>";
    };
